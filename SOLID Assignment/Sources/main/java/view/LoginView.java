...
public class LoginView extends JFrame {
    ...
    private void initializeFields() {
        info = new JLabel("<html>Admin role can be added only from database to <br/> an existing & hard working employee!</html>");

        tfUsername = new JTextField();
        tfPassword = new JPasswordField();
        btnLogin = new JButton("Login");
        btnRegister = new JButton("Register as new employee");
    }
